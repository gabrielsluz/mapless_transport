...
# Main training loop
model.learn(
    total_timesteps=4_500_000, log_interval=100, progress_bar=True, reset_num_timesteps=True,
...
model.learn(
    total_timesteps=500_000, log_interval=100, progress_bar=True, reset_num_timesteps=False,
    callback=eval_callback,
    tb_log_name=exp_name)
