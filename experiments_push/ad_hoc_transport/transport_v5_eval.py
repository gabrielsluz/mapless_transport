...
config = TransportationEnvConfig(
    world_config= TransportationWorldConfig(
        obstacle_l = obstacle_l_dict['circle_middle_120x120'],
        object_l=[
            object_desc
            ],
        n_rays = 72,
...
# Load agent
model = SAC.load('capsule_conditioned_model_ckp/triangle/pos_tol_2_angle_pi18_corridor_10_20_reward_scale_10_success_1_death_1_nn_3x256_triangle')

model_position = SAC.load('capsule_conditioned_model_ckp/triangle/pos_tol_3_angle_pi_corridor_10_20_reward_scale_10_success_1_death_1_nn_3x256_triangle')
