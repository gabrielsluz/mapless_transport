...
# Load agent
model = SAC.load('capsule_conditioned_model_ckp/rectangle/pos_tol_2_angle_pi18_corridor_10_20_reward_scale_10_success_1_death_1_nn_3x256')

model_position = SAC.load('capsule_conditioned_model_ckp/rectangle/pos_tol_3_angle_pi_corridor_10_20_reward_scale_10_success_1_death_1_nn_3x256')
