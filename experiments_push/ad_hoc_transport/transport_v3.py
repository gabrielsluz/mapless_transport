...
from research_envs.envs.transportation_pose_capsule_reward_env import TransportationEnvConfig, TransportationEnv
...
subgoal_tolerance = {'pos':4, 'angle':np.pi/4}
...
config = TransportationEnvConfig(
    world_config= TransportationWorldConfig(
        obstacle_l = obstacle_l_dict['very_big_U'],
        object_l=[
            object_desc
            ],
        n_rays = 72,
...
# Load agent
model = SAC.load('model_ckp/capsule_reward_pose_control_capsule_potential_start_obj_obs_pos_tol_2_angle_pi_18')
