...
def drawPretty(self):
    ...
    # Draw capsules
    for capsule_line in capsule_line_l:
        ...
        c = ((94+255)//2, (192+255)//2, (250+255)//2)
        cv2.fillPoly(screen, [points], color=c)
...
save_video(frame_l, 'mapless_videos/capsule_'+exp_name+'.mp4')