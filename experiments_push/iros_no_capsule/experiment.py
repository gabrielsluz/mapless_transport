...
from research_envs.envs.transportation_pose_env_v2 import TransportationEnvConfig, TransportationEnv
...
# Main training loop
model.learn(
    total_timesteps=1_400_000, log_interval=100, progress_bar=True, reset_num_timesteps=True,
...
model.learn(
    total_timesteps=100_000, log_interval=100, progress_bar=True, reset_num_timesteps=False,
    callback=eval_callback,
    tb_log_name=exp_name)
