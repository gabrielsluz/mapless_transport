# Visualizar a política aprendida pelo agente com setas.
# O agente é colocado em cada posição do grid e a política é executada.
# Colocar o goal em uma posição fixa.
...
obs_l_dict = {
    ...
    for k in [
        ...
        '4_circles', 'sparse_1', '1_circle',
        '1_rectangle', '1_triangle',
